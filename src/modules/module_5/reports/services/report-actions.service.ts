...
import { User, TargetType, ReportStatus } from "@/lib/types/report";
...
export class ReportActionsService {
  ...
  public async updateContentVisibility(
    ...
    // Determinar la tabla a actualizar basado en el tipo de objetivo
    ...
    // 1. Ocultar el contenido en su tabla original
    ...
    // 2. Marcar los reportes de este contenido como aprobados
